...
#  '../mapreduce-lib/guagua-examples-0.8.0-SNAPSHOT.jar': Jar files include master, worker and user intercepters
...
$BIN_DIR/guagua jar $BIN_DIR/../mapreduce-lib/guagua-examples-0.8.0-SNAPSHOT.jar \
        -i kmeans  \
