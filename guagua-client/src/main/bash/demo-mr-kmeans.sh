...
#  '../mapreduce-lib/guagua-examples-0.7.0.jar': Jar files include master, worker and user intercepters
...
$BIN_DIR/guagua jar $BIN_DIR/../mapreduce-lib/guagua-examples-0.7.0.jar \
        -i kmeans  \
