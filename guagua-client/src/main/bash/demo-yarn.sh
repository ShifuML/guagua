...
#  '../yarn-lib/guagua-examples-0.8.0-SNAPSHOT.jar': Jar files include master, worker and user intercepters
...
$BIN_DIR/guagua -y \
        jar $BIN_DIR/../yarn-lib/guagua-examples-0.8.0-SNAPSHOT.jar \
        -i sum  \
