...
export HADOOP_CLASSPATH="../lib/guagua-mapreduce-examples-0.4.1.jar:../lib/guava-14.0.1.jar:../lib/guagua-mapreduce-0.4.1.jar:../lib/guagua-core-0.4.1.jar:../lib/zookeeper-3.4.5.jar"

hadoop jar ../lib/guagua-mapreduce-0.4.1.jar \
    ml.shifu.guagua.mapreduce.GuaguaMapReduceClient   \
    -libjars ../lib/guagua-mapreduce-examples-0.4.1.jar,../lib/guava-14.0.1.jar,../lib/guagua-mapreduce-0.4.1.jar,../lib/guagua-core-0.4.1.jar,../lib/zookeeper-3.4.5.jar \
    -i sum  \
    -z ${ZOOKEEPER_SERVERS}  \
