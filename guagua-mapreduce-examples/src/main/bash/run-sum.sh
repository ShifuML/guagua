...
export HADOOP_CLASSPATH="../lib/guagua-mapreduce-examples-0.5.0-SNAPSHOT.jar:../lib/guava-14.0.1.jar:../lib/guagua-mapreduce-0.5.0-SNAPSHOT.jar:../lib/guagua-core-0.5.0-SNAPSHOT.jar:../lib/zookeeper-3.4.5.jar"

hadoop jar ../lib/guagua-mapreduce-0.5.0-SNAPSHOT.jar \
    ml.shifu.guagua.mapreduce.GuaguaMapReduceClient   \
    -libjars ../lib/guagua-mapreduce-examples-0.5.0-SNAPSHOT.jar,../lib/guava-14.0.1.jar,../lib/guagua-mapreduce-0.5.0-SNAPSHOT.jar,../lib/guagua-core-0.5.0-SNAPSHOT.jar,../lib/zookeeper-3.4.5.jar \
    -i sum  \
    -z ${ZOOKEEPER_SERVERS}  \
