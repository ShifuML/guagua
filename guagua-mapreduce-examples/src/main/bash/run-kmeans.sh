...
#  '../mapreduce-lib/guagua-mapreduce-examples-0.7.1.jar': Jar files include master, worker and user intercepters
...
./guagua jar ../mapreduce-lib/guagua-mapreduce-examples-0.7.1.jar \
        -i kmeans  \
