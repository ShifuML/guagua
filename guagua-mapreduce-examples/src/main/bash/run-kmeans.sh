...
#  '../mapreduce-lib/guagua-mapreduce-examples-0.7.0.jar': Jar files include master, worker and user intercepters
...
./guagua jar ../mapreduce-lib/guagua-mapreduce-examples-0.7.0.jar \
        -i kmeans  \
