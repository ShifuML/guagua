...
/**
 * {@link LinearRegressionOutput} is used to write the final model output to file system.
 */
public class LinearRegressionOutput extends
        BasicMasterInterceptor<LinearRegressionParams, LinearRegressionParams> {
