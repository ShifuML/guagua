...
/**
 * <code>GuaguaOptionsParser</code> is a utility to parse command line arguments generic to the Hadoop framework.
 * 
 * <code>GenericOptionsParser</code> recognizes several standard command line arguments, enabling applications to easily
 ...
 * 
 * <p>
 * Generic command line arguments <strong>might</strong> modify <code>Configuration </code> objects, given to
 * constructors.
 * </p>
 * 
 * <p>
...
public class GuaguaOptionsParser {
    ...
    /**
     * Create a <code>GuaguaOptionsParser<code> to parse only the generic Hadoop  
     * arguments. 
     * 
