...
/**
 * {@link SumWorker} is used to compute the sum value for each line.
 * 
 * <p>
...
public class SumWorker
     ...
     * (non-Javadoc)
     * 
     * @see ml.shifu.guagua.mapreduce.AbstractWorkerComputable#init(ml.shifu.guagua.worker.WorkerContext)
     */
    @Override
    public void init(
     ...
     * (non-Javadoc)
     * 
     * @see ml.shifu.guagua.mapreduce.AbstractWorkerComputable#doCompute(ml.shifu.guagua.worker.WorkerContext)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see ml.shifu.guagua.mapreduce.AbstractWorkerComputable#load(org.apache.hadoop.io.LongWritable,
     * org.apache.hadoop.io.Text, ml.shifu.guagua.worker.WorkerContext)
     */
    @Override
