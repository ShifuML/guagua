...
export HADOOP_CLASSPATH="../lib/guagua-yarn-examples-0.6.0-SNAPSHOT.jar:../lib/guagua-yarn-0.6.0-SNAPSHOT.jar:../lib/gson-2.2.2.jar:../lib/guava-11.0.2.jar:../lib/guagua-core-0.6.0-SNAPSHOT.jar:../lib/zookeeper-3.4.5.jar"

hadoop jar ../lib/guagua-yarn-examples-0.6.0-SNAPSHOT.jar \
    ml.shifu.guagua.yarn.GuaguaYarnClient  \
    -libjars ../lib/guagua-yarn-examples-0.6.0-SNAPSHOT.jar,../lib/guagua-yarn-0.6.0-SNAPSHOT.jar,../lib/gson-2.2.2.jar,../lib/guava-11.0.2.jar,../lib/guagua-core-0.6.0-SNAPSHOT.jar,../lib/zookeeper-3.4.5.jar \
    -i sum  \
